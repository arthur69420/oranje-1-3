...
/* Echte vlaggen via flagcdn (accuraat en werken overal). Map: interne code
   naar de flagcdn-slug (ISO-2, of gb-eng/gb-sct/gb-wls voor de Britse landen). */
const FLAG = {
  NED:"nl", ARG:"ar", FRA:"fr", BRA:"br", ENG:"gb-eng", ESP:"es", POR:"pt",
  GER:"de", BEL:"be", ITA:"it", CRO:"hr", URU:"uy", COL:"co", MAR:"ma",
  JPN:"jp", DEN:"dk", SUI:"ch", SEN:"sn", USA:"us", MEX:"mx", SRB:"rs",
  AUT:"at", TUR:"tr", NOR:"no", SWE:"se", POL:"pl", UKR:"ua", ECU:"ec",
  NGA:"ng", CIV:"ci", KOR:"kr", AUS:"au", EGY:"eg", ALG:"dz", GHA:"gh",
  SCO:"gb-sct", HUN:"hu", CZE:"cz", WAL:"gb-wls", CAN:"ca", CMR:"cm",
  IRN:"ir", PER:"pe", CHI:"cl", KSA:"sa", QAT:"qa", CRC:"cr", PAN:"pa", TUN:"tn"
};
